...
- [Лабораторна робота №1](#лабораторна-робота-1)
  ...
  - [Хід роботи](#хід-роботи)
    ...
    - [Необхідні вхідні данні](#необхідні-вхідні-данні)
...
База данних створюється для застосунку з піснями. У застосунку буде багато пісень, від різних авторів та з різними жанрами, які користувачі зможуть додавати до плейлистів, ділитися плейлистами, зберігати плейлисти на потім у своїх аккантах щоб послухали потім пісні. Шукати популярні пісні певного жанру та таке інше.

### Приклади застосування

1. Знайти найпопулярніші пісні за жанром
2. Подивитись жанри певного автора
3. Знайти які пісні найчастіше додають до плейлистів
4. Знайти дві схожі пісні
5. Подивитись кількість пісень автора
6. Переглянути жанри певного плейлиста
7. Переглянути улюблений жанр користувача
...
### Необхідні вхідні данні

Оскільки база данних більше про створення та взаємодію саме з плейлистами, пісні, авторів та жанри потрібно буде заздалегідь додати, щоб користувачі могли додавати їх до плейлистів.  
Аккаунти користувачів, плейлисти та відношення у асоціативних сутностях з'являться під час роботи застосунку
