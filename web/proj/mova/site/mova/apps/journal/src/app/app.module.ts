...
import * as fromStories from './store/stories';
import * as fromContacts from './store/contacts';
import * as fromFaq from './store/faq';
import * as fromStudents from './store/students';
...
@NgModule({
  ...
  imports: [
    ...
    StoreModule.forFeature(fromFaq.fAQFeatureKey, fromFaq.reducer),
    StoreModule.forFeature(fromStudents.studentFeatureKey, fromStories.reducer),
